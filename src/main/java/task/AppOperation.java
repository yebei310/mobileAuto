...
public  class AppOperation {
    final  static Logger logger = LoggerFactory.getLogger(AppOperation.class);
    // 打开app弹框选择年级
    public   void selectGrade() throws Exception{
        try {
            ...
            logger.info("选择年级suceess");
        }catch (Exception e){
            e.printStackTrace();
            System.out.printf("没有定位到年级12"+e.getMessage());
            logger.info("没有定位到年级22"+e.getMessage());
        }
    ...
    public  void  login()throws Exception {
        ...
        //输入账号密码
        androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_1);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_3);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_7);
        androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_1);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_8);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_2);
        androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_4);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_2);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_4);
        androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_5);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_3);
        ...
        androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_2);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_4);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_2);
        androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_4);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_5);androidDriver.pressKeyCode(AndroidKeyCode.KEYCODE_3);
...
//                System.out.printf("进入学习模块，获取到title：" + title);
                logger.info("进入学习模块，获取到title：" + title);
    ...
    //学生端上课模块
    public  void gotoClass()throws Exception{
